...
public class AIGunController : MonoBehaviour
{
    ...
    void CheckSensors()
    {
        AIGunTank.Sensor sensor = AITank.CheckSensors();
        switch (sensor)
        {
            case AIGunTank.Sensor.Front:
                axisX = randomDirection;
                axisY = 0;
                axisXOverriden = true;
                axisYOverriden = true;
                break;
            case AIGunTank.Sensor.FrontRight:
                axisX = -1;
                axisXOverriden = true;
                axisYOverriden = false;
                break;
            case AIGunTank.Sensor.FrontLeft:
                axisX = 1;
                axisXOverriden = true;
                axisYOverriden = false;
                break;
            case AIGunTank.Sensor.Left:
                if (axisX < 0)
                {
                    axisX = 0;
                    axisXOverriden = true;
